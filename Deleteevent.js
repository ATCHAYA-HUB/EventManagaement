...
export default function Deleteevent() {
  ...
  return (
    <>
    <div className='eventhomeupdate'><div className='imgeventupdate'>
        
           <center> <form ><br/><br/><br/>
            <div style={{left:"-100px", top:"100px",position:"relative"}}>
            <label style={{marginLeft:"350px",fontSize:"20px",fontWeight:"700"}}>Event ID:</label>
            <input style={{fontSize:"20px",textAlign:"center"}} className='tick1' type="text" value={id}  onChange = {e => setId(e.target.value)} id="fname" placeholder='Event ID'/>
           </div><br/>
