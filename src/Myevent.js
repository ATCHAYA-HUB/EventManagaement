...
export default function Myevent() {
  ...
  <datalist id="browsers">
    ...
    <option value="Fan-Meet"></option>
            ...
            <label style={{marginLeft:"-180px"}}>Event Agenda:</label><br></br>
            <textarea id="lname" value={agenda}  onChange = {e => setAgenda(e.target.value)} placeholder="Agenda" rows="10" cols="50"/><br></br>
